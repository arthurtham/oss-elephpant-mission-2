...
module.exports = async function (helper) {
  ...
  const { criticalIs1, criticalNot1, criticalNot2 } = helper.validationFields;
  ...
  if (criticalIs1 || !criticalNot1 || !criticalNot2) {
    return helper.fail(`
      Critical Failure: `+criticalIs1+criticalNot1+criticalNot2+`
    `);
  }
